<template>
  <v-dialog v-model="dialog" persistent max-width="500px">
    ...
    <v-card>
      ...
      <slot name="text">
        <v-card-text
          >Cost of the original painting- {{ painting.priceEn }} <br />Delivery and insurance is at
          the buyer's expense <br />The deadline for sending the painting outside the European Union
          is 2-3 weeks</v-card-text
        ></slot
      >
      <v-card-text>
